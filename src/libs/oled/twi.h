...
#define TWI_SR_ALMOA_ACK                                                                                               \
    0x68 // Arbitration Lost in SLA+R/W as Master; Own Slave address has been received; ACK returned
#define TWI_SR_GCALL_ACK 0x70 // General call address has been received; ACK returned
#define TWI_SR_ALMGA_ACK                                                                                               \
    0x78 // Arbitration lost in SLA+R/W as Master; General call address has been received; ACK returned
...
#define TWI_ST_ALMOA_ACK                                                                                               \
    0xB0 // Arbitration lost in SLA+R/W as Master; own SLA+R has been received; ACK has been received
...
//      1     0    -    16
//      1     1    -    64
#define TWI_FREQ(BIT_RATE, PRESCALER)                                                                                  \
    {                                                                                                                  \
        TWI_TWBR = BIT_RATE;                                                                                           \
        TWI_TWSR |= (TWI_TWSR & 0x03) | PRESCALER;                                                                     \
    }
...
// (1 << TWSTA) - TWI Start
#define TWI_START()                                                                                                    \
    { TWI_TWCR = (1 << TWEN) | (1 << TWINT) | (1 << TWSTA); }
...
// (1 << TWSTO) - TWI Stop
#define TWI_STOP()                                                                                                     \
    { TWI_TWCR = (1 << TWEN) | (1 << TWINT) | (1 << TWSTO); }
